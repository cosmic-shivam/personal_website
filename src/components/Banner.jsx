import bannerImage from "../photo/shivam.jpg";
...
const Banner = () => {
  ...
  useEffect(() => {
    const typed = new Typed(el.current, {
      strings: ["Investor", "Frontend Developer", "Backend Developer"], // Strings to display
    ...
    >
      ...
      <div className="w-full flex items-center justify-center text-white ">
        ...
        <div className="w-2/3 space-y-2  ms-10">
          ...
          <h1 className="text-5xl font-bold">Shivam Sanjay Bhendekar</h1>
      ...
      <div className=" w-full flex justify-center">
        {/* image */}
        <img className="rounded-full shadow-lg w-95 h-80" src={bannerImage} />
